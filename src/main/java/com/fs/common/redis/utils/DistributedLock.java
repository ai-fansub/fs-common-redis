package com.fs.common.redis.utils;

import com.fs.common.core.exception.ErrorType;
...
import static com.fs.common.core.exception.ServiceStatusCode.ERROR_SAME_TIME_ACT;
    ...
    */
    ...
    public boolean tryAcquireLock(String lockKey) {
        ...
        if (!isLocked) {
            ...
            // 에러 처리
            throw new FsCommonException(ErrorType.ERROR, ERROR_SAME_TIME_ACT, "ERROR_SAME_TIME_ACT !!");
        }
